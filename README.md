...
client certificate and key this service presents to `iam-db` (ADR-0516), and the
CA every D73 enrolment token carries. When one of them changes it logs which
