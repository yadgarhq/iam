...
| ------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `IAM_DB_HOST` / `IAM_DB_PORT`                                | required — from `iamDb.host` / `iamDb.port`                                                                                                                    | the twin's headless Service                                                                                                                                                                                                                                                                                                                                                                       |
| `YADGAR_KEYS_DIR`                                            | —                                                                                                                                                              | where `crypto::Keys::from_env` reads the AES-GCM/HMAC keys (D72)                                                                                                                                                                                                                                                                                                                                  |
| `LISTEN`                                                     | required — `0.0.0.0:50052`, matching the chart's `containerPort`                                                                                               |                                                                                                                                                                                                                                                                                                                                                                                                   |
...
| `LOGIN_RESPONSE_FLOOR_MS`                                    | required — from `login.responseFloorMs`                                                                                                                        | the shortest time `Login` may answer in                                                                                                                                                                                                                                                                                                                                                           |
| `REDEEM_RESPONSE_FLOOR_MS`                                   | required — from `redeemEnrolment.responseFloorMs`                                                                                                              | the same, for `RedeemEnrolment`, which does more work                                                                                                                                                                                                                                                                                                                                             |
| `ENROLMENT_GATEWAY`                                          | always rendered, empty included; unset makes `IssueEnrolment` refuse with `FAILED_PRECONDITION` while the process keeps serving (an argued ADR-0569 exception) | the address enrolment tokens carry; unset disables IssueEnrolment only                                                                                                                                                                                                                                                                                                                            |
