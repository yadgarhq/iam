...
//! the composition. So the assertion below is about ELAPSED TIME rather than
...
use yadgar_iam::serve::{self, Drain};
...
/// responsive-but-slow `iam-db`, with no deadline anywhere to end it.
#[tokio::test]
